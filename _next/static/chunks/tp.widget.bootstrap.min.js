              ...
              try {
                for (
                  ...
                  if ("childList" === o.type) {
                    ...
                    try {
                      for (
                        var c, u = o.addedNodes[Symbol.iterator]();
                        !(r = (c = u.next()).done);
                        r = !0
                      )
      ...
      function (e, t, i) {
        ...
        t.exports = function (e) {
          ...
          if (e.sku) {
            ...
            if (
              ((e.templateId === p.productReviewsSEO ||
                e.templateId === p.productReviewsMultiSourceSEO) &&
                e.name) ||
              ...
              return (
                ...
                (l =
                  "https://widget.trustpilot.com" +
                  (e === p.productReviewsMultiSourceSEO
        ...
        i(l, [
          ...
          },
          {
            ...
            value: function (e) {
              ...
              (0, s.default)(i);
              var n = new o.default({ container: e, dataset: i });
              return (
                n.initialize(),
      ...
      function (e, t, i) {
        ...
        (i.defaultLocale = "en-US"),
          (i.title =
            ...
            n(i, "fi-FI", "Trustpilotissa julkaistut asiakkaiden arvostelut"),
            n(i, "fr-FR", "Avis clients publiés sur Trustpilot"),
            n(i, "fr-BE", "Avis clients publiés sur Trustpilot"),
            n(i, "de-DE", "Auf Trustpilot veröffentlichte Kundenbewertungen"),
            n(i, "de-AT", "Auf Trustpilot veröffentlichte Kundenbewertungen"),
            n(i, "de-CH", "Auf Trustpilot veröffentlichte Kundenbewertungen"),
            n(i, "it-IT", "Recensioni dei clienti pubblicate su Trustpilot"),
            n(i, "ja-JP", "Trustpilot 提供のお客様レビュー"),
            n(i, "nb-NO", "Kundenes anmeldelser via Trustpilot"),
            n(i, "pl-PL", "Recenzje klientów opublikowane na Trustpilot"),
            n(i, "pt-PT", "Opiniões de clientes publicadas pela Trustpilot"),
            n(i, "pt-BR", "Avaliações de clientes fornecidas pela Trustpilot"),
            n(i, "ru-RU", "Customer reviews powered by Trustpilot"),
            n(i, "es-ES", "Opiniones de clientes publicadas en Trustpilot"),
            n(i, "sv-SE", "Kundomdömen möjliggjorda av Trustpilot"),
            i));
      },
      {},
    ],
