var OneTrustStub = (t => {
    ...
    function m(t, e, i) {
        ...
        var o = n(t.getAttribute("style")),
            ...
            e = "",
            e = i && o ? (() => {
                for (var t = o.split(";").concat(r.split(";")).filter(function(t) {
                        return 0 !== t.length
    ...
    }(n = s = s || {}).ping = "ping", n.addEventListener = "addEventListener", n.removeEventListener = "removeEventListener", n.hasSection = "hasSection", n.getSection = "getSection", n.getField = "getField", n.getGPPData = "getGPPData";
    var g = new function() {
            var r = this;
            this.LOCATOR_NAME = "__gppLocator", this.win = window, this.customInit = "CUSTOMINIT", this.init = function() {
                ...
                e && e.__gppCall && (n = e.__gppCall, (0, r.win.__gpp)(n.command, function(t, e) {
                    t = {
                        __gppReturn: {
                            returnValue: t,
                            success: e,
    ...
    v.prototype.initConsentSDK = function() {
        ...
        var n, a = "," + this.serialiseArrayToString(t) + ",",
            ...
            r = (this.otDataLayer.ignore || void 0 === o[this.otDataLayer.name] ? this.otDataLayer.ignore || (o[this.otDataLayer.name] = [{
    ...
    var b = new y;
    return t.OtSDKStub = y, t.otSdkStub = b, Object.defineProperty(t, "__esModule", {
        value: !0
    }), t
})({});