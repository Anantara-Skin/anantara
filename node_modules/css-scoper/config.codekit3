...
"buildSteps": [
	{
		...
		"stepType": 1,
		"uuidString": "94998F52-D7BB-46D5-AB08-DBD71A703DF5"
		}
	],
"creatorBuild": "25849",
"files": {
...
"projectAttributes": {
	"creationDate": 520532838,
	"displayValue": "scoper",
	"displayValueWasSetByUser": 1,
	"iconImageName": "meme-kanye"
	},
"projectSettings": {
	"abortBuildOnError": 1,
	...
	"esLintRules": {
		...
		"no-extra-parens": {
			"active": 0,
			"optionString": "'all', {'conditionalAssign': false, 'returnAssign': false, 'nestedBinaryExpressions': false, 'ignoreJSX': 'none'}"
			},
		"no-extra-semi": {
			"active": 1,
			"optionString": ""
