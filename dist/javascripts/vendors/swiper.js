        ...
        void 0 !== r &&
          ...
          (V(t[a]) && V(i[a])
            ? i[a].__swiper__
              ...
              : W(t[a], i[a])
            : !V(t[a]) && V(i[a])
              ? ((t[a] = {}), i[a].__swiper__ ? (t[a] = i[a]) : W(t[a], i[a]))
              : (t[a] = i[a]));
      }
    }
  }
...
const te = {
  ...
  updateSlides: function () {
    ...
    for (let i = 0; i < c; i += 1) {
      x = 0;
      const n = p.eq(i);
      if ((y && e.grid.updateSlide(i, n, c, t), "none" !== n.css("display"))) {
        if ("auto" === a.slidesPerView) {
          ...
          (x = (r - (a.slidesPerView - 1) * w) / a.slidesPerView),
            a.roundLengths && (x = Math.floor(x)),
    ...
    if (
      ...
      q(e.wrapperEl, "--swiper-centered-offset-before", -u[0] + "px"),
        q(
          e.wrapperEl,
  ...
  updateClickedSlide: function (e) {
    ...
    (t.clickedSlide = a),
      t.virtual && t.params.virtual.enabled
        ? (t.clickedIndex = parseInt(G(a).attr("data-swiper-slide-index"), 10))
        : (t.clickedIndex = i),
    ...
    if (
      ...
      if (0 === t) l[e ? "scrollLeft" : "scrollTop"] = -p;
        ...
        if (!r.support.smoothScroll)
          return (
            X({ swiper: r, targetPosition: -p, side: e ? "left" : "top" }), !0
          );
...
function ae({ swiper: e, runCallbacks: t, direction: s, step: a }) {
...
const ie = {
  slideTo: function (e = 0, t = this.params.speed, s = !0, a, i) {
    ...
    if ((r.animating && l.preventInteractionOnTransition) || (!h && !a && !i))
      return !1;
...
const re = {
  loopCreate: function () {
    ...
    for (let e = 0; e < l.length; e += 1)
      i.append(G(l[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
    for (let e = n.length - 1; e >= 0; e -= 1)
      i.prepend(G(n[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
  },
  loopFix: function () {
    const e = this;
...
function ne(e) {
  ...
  p && o.target && o.target.shadowRoot && c && (d = G(c[0]));
...
function le(e) {
  ...
  if (!s.allowTouchMove)
    return (
      G(o.target).is(a.focusableElements) || (s.allowClick = !1),
      void (
        a.isTouched &&
        (Object.assign(r, { startX: p, startY: c, currentX: p, currentY: c }),
        (a.touchStartTime = F()))
      )
    );
  if (a.isTouchEvent && i.touchReleaseOnEdges && !i.loop)
    if (s.isVertical()) {
      if (
        (c < r.startY && s.translate <= s.maxTranslate()) ||
        (c > r.startY && s.translate >= s.minTranslate())
      )
  ...
  if (
    ...
    G(o.target).is(a.focusableElements)
  )
  ...
  if (
    ...
    h > 0 && a.currentTranslate > s.minTranslate()
      ? ((f = !1),
        i.resistance &&
          (a.currentTranslate =
            s.minTranslate() -
            1 +
            (-s.minTranslate() + a.startTranslate + h) ** g))
      : h < 0 &&
        ...
        i.resistance &&
          (a.currentTranslate =
            s.maxTranslate() +
            1 -
            (s.maxTranslate() - a.startTranslate - h) ** g)),
...
function oe(e) {
  ...
  if (p > a.longSwipesMs) {
    ...
    "next" === t.swipeDirection &&
      (g >= a.longSwipesRatio
        ? t.slideTo(a.rewind && t.isEnd ? h : u + v)
        : t.slideTo(u)),
...
const fe = {
    attachEvents: function () {
      ...
      (e.onTouchStart = ne.bind(e)),
        ...
        (e.onTouchEnd = oe.bind(e)),
        s.cssMode && (e.onScroll = ce.bind(e)),
        (e.onClick = pe.bind(e)),
        a.touch && !ue && (t.addEventListener("touchstart", me), (ue = !0)),
        he(e, "on");
    },
  ...
  ge = (e, t) => e.grid && t.grid && t.grid.rows > 1;
const ve = {
  addClasses: function () {
    const e = this,
    ...
    transition: {
      ...
      transitionStart: function (e = !0, t) {
        ...
        a.cssMode ||
          ...
          ae({ swiper: s, runCallbacks: e, direction: t, step: "Start" }));
      },
      transitionEnd: function (e = !0, t) {
        ...
        (s.animating = !1),
          a.cssMode ||
            (s.setTransition(0),
            ae({ swiper: s, runCallbacks: e, direction: t, step: "End" }));
      },
    },
    slide: ie,
    loop: re,
...
class Se {
  constructor(...e) {
    ...
    (a.__swiper__ = !0),
      (a.support = J()),
      (a.device = Q({ userAgent: s.userAgent })),
      (a.browser = Z()),
      (a.eventsListeners = {}),
...
function xe({ swiper: e, extendParams: t, on: s, emit: a }) {
  function i(t) {
    let s;
    return (
      t &&
...
function $e({ swiper: e, extendParams: t, on: s, emit: a }) {
  ...
  function d() {
      ...
      if (
        (s.dynamicBullets &&
          ...
          s.dynamicMainBullets > 1 &&
            ...
            ((n += p - (e.previousIndex - e.loopedSlides || 0)),
    ...
    if (
      ("fraction" === s.type &&
        (d.find(Ee(s.currentClass)).text(s.formatFractionCurrent(p + 1)),
  ...
  function p() {
    ...
    if ("bullets" === t.type) {
      ...
      i.html(r), (e.pagination.bullets = i.find(Ee(t.bulletClass)));
    }
    "fraction" === t.type &&
      ((r = t.renderFraction
  ...
  s("init", () => {
    !1 === e.params.pagination.enabled ? m() : (c(), p(), d());
  }),
    s("activeIndexChange", () => {
...
function Me({ swiper: e, extendParams: t, on: s, emit: a }) {
  ...
  function w(t) {
    ...
    l.touch
      ? (d[u](a.start, g, p), d[u](a.move, v, p), d[u](a.end, b, c))
      : (d[u](r.start, g, p), i[u](r.move, v, p), i[u](r.end, b, c));
  }
  function C() {
    ...
    0 === r.length &&
      ((r = G(`<div class="${e.params.scrollbar.dragClass}"></div>`)),
      i.append(r)),
      Object.assign(t, { $el: i, el: i[0], $dragEl: r, dragEl: r[0] }),
      a.draggable && e.params.scrollbar.el && e.scrollbar.el && w("on"),
      i &&
  ...
  t({
    ...
    s("init", () => {
      !1 === e.params.scrollbar.enabled ? S() : (C(), m(), u());
    }),
...
function ke({ swiper: e, extendParams: t, on: s, emit: a }) {
  t({
    lazy: {
      checkInView: !1,
      enabled: !1,
            ...
            if (null != e && e && (!e || e.params) && !e.destroyed) {
              if (
                (o
                  ...
                  : (p && (l.attr("srcset", p), l.removeAttr("data-srcset")),
  ...
  function l() {
    ...
    else if (d > 1) for (let e = i; e < i + d; e += 1) p(e) && n(e);
    else n(i);
    if (o.loadPrevNext)
  ...
  function o() {
    ...
    c ? (l(), s.off("scroll", o, m)) : i || ((i = !0), s.on("scroll", o, m));
  }
  s("beforeInit", () => {
...
function Pe({ swiper: e, extendParams: t, on: s, emit: a }) {
  ...
  function c() {
    e.params.autoplay.disableOnInteraction ? l() : (a("autoplayPause"), o()),
      ["transitionend", "webkitTransitionEnd"].forEach((t) => {
        e.$wrapperEl[0].removeEventListener(t, p);
      });
  }
  function u() {
    e.params.autoplay.disableOnInteraction ||
      ((e.autoplay.paused = !1), a("autoplayResume"), r());
  }
      ...
      if (e.params.autoplay.enabled) {
        ...
        N().addEventListener("visibilitychange", d),
          e.params.autoplay.pauseOnMouseEnter &&
            (e.$el.on("mouseenter", c), e.$el.on("mouseleave", u));
      }
    }),
