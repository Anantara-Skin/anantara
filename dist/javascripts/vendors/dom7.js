import { getDocument as t, getWindow as e } from "./ssr-window.js";
...
function r(i, s) {
  ...
  if ("string" == typeof i) {
    ...
    if (t.indexOf("<") >= 0 && t.indexOf(">") >= 0) {
      ...
      const n = o.createElement(e);
      n.innerHTML = t;
      for (let t = 0; t < n.childNodes.length; t += 1) l.push(n.childNodes[t]);
    } else
      l = (function (t, e) {
  ...
  } else if (i.nodeType || i === r || i === o) l.push(i);
...
function f(...t) {
  const e = i(t.map((t) => t.split(" ")));
  return (
    s(this, (t) => e.filter((e) => t.classList.contains(e)).length > 0).length >
    0
  );
}
function u(t, e) {
...
function a(...t) {
  ...
  function o(t) {
    ...
    if ((s.indexOf(t) < 0 && s.unshift(t), r(e).is(n))) i.apply(e, s);
    else {
      const t = r(e).parents();
      for (let e = 0; e < t.length; e += 1) r(t[e]).is(n) && i.apply(t[e], s);
    }
  }
  function l(t) {
  ...
  for (let t = 0; t < r.length; t += 1) {
    ...
    for (let t = 0; t < this.length; t += 1) {
      ...
      if (
        (!n && r.dom7Listeners
          ? (o = r.dom7Listeners[e])
          : n && r.dom7LiveListeners && (o = r.dom7LiveListeners[e]),
        o && o.length)
      )
        for (let t = o.length - 1; t >= 0; t -= 1) {
          ...
          (i &&
            ...
            ? (r.removeEventListener(e, n.proxyListener, s), o.splice(t, 1))
            : i ||
              (r.removeEventListener(e, n.proxyListener, s), o.splice(t, 1));
        }
    }
...
function E() {
  if (this.length > 0) {
    const n = e(),
      ...
      h = s.clientLeft || o.clientLeft || 0,
      f = s === n ? n.scrollY : s.scrollTop,
      u = s === n ? n.scrollX : s.scrollLeft;
    return { top: r.top + f - l, left: r.left + u - h };
  }
  return null;
}
function b() {
...
function x(t, n) {
  ...
  if (2 === arguments.length && "string" == typeof t) {
    for (s = 0; s < this.length; s += 1) this[s].style[t] = n;
    return this;
  }
  return this;
}
...
function w(e) {
  ...
  for (s = 0; s < this.length; s += 1)
    if ("string" == typeof e) {
      ...
      for (t.innerHTML = e, r = t.childNodes.length - 1; r >= 0; r -= 1)
        this[s].insertBefore(t.childNodes[r], this[s].childNodes[0]);
...
function F(t) {
  ...
  for (let n = 0; n < this.length; n += 1) {
    ...
    for (; i; ) t ? r(i).is(t) && e.push(i) : e.push(i), (i = i.parentNode);
  }
  return r(e);
}
function q(t) {
  let e = this;
  return void 0 === t ? r([]) : (e.is(t) || (e = e.parents(t).eq(0)), e);
}
function j(t) {
  const e = [];
  for (let n = 0; n < this.length; n += 1) {
...
function k(t) {
  ...
  for (let n = 0; n < this.length; n += 1) {
    ...
    for (let n = 0; n < i.length; n += 1) (t && !r(i[n]).is(t)) || e.push(i[n]);
  }
  return r(e);
}
function W() {
